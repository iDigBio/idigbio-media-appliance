...
def test_user_api_login(json_in_out, client):
    res = client.post(url_for('user_api.userapi'), data=json.dumps({
...
def test_user_api_logout(json_in_out, client):
    ...
    res = client.delete(url_for('user_api.userapi'), headers=json_in_out)
    assert res.json == {}
...
def test_user_api_get(json_in_out, client):
    ...
    res = client.get(url_for('user_api.userapi'), headers=json_in_out)
